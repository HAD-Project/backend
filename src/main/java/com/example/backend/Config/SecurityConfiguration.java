...
//                .requestMatchers(GET,"/api/v1/receptionist/**")
//                .hasAnyAuthority(ADMIN_READ.name(),RECEPTIONIST_READ.name())
//                .requestMatchers(POST,"/api/v1/receptionist/**").hasAnyAuthority(ADMIN_CREATE.name())
//                .requestMatchers(DELETE,"/api/v1/receptionist/**").hasAnyAuthority(ADMIN_DELETE.name())
//                .requestMatchers(PUT,"/api/v1/receptionist/**").hasAnyAuthority(ADMIN_UPDATE.name())
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
