...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .requestMatchers(GET, "/api/v1/appointment/**").hasAnyAuthority(RECEPTIONIST_READ.name())
                .requestMatchers(POST, "/api/v1/appointment/**").hasAnyAuthority(RECEPTIONIST_CREATE.name())
                .requestMatchers(PUT, "/api/v1/appointment/**").hasAnyAuthority(RECEPTIONIST_UPDATE.name())
                .requestMatchers(DELETE, "/api/v1/appointment/**").hasAnyAuthority(RECEPTIONIST_DELETE.name())
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
